...
python3 inference/transcribe.py $audio --language Chinese --word_timestamps False --device $device --suppress_tokens "-1" -o "logs/test/" --condition_on_previous_text True