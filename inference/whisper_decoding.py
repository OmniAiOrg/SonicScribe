...
class DecodingTask:
    ...
    def decode_tokens(self, tokens:Tensor):
        return self.tokenizer.decode_with_timestamps(tokens[0].tolist())
...
if __name__ == "__main__":
    ...
    tagger = WhisperDurationTagger('tiny', device=='cpu')
    model: Whisper = tagger.model
    ...
    for b in loader:
        ...
        print(tagger.tokenizer.decode(b.data[0]))
